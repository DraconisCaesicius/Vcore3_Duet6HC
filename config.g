...
if {network.interfaces[0].type = "ethernet"}
    ...
    M552 S1
;M552 S1 P192.168.1.14                   ; enable network CHANGED inclusions above
...
M208 X500 Y500 Z500 S0                         ; set axis maxima CHANGED default is X310, Y300, Z300
...
M950 H0 C"out1" T0 Q11                                 ; create bed heater output on out1 and map it to sensor 0, lower switching frequency to 11Hz <-----------
                                                       ; CHANGED C"out0" to C"out1" and comment from out5 to out1
