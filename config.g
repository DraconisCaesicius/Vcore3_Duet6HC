...
M92 X80.00 Y80.00 Z800.00 E408.16            ; set steps per mm
M566 X400.00 Y400.00 Z6.00 E120.00          ; set maximum instantaneous speed changes (mm/min)
M203 X10800.00 Y10800.00 Z600.00 E400.00      ; set maximum speeds (mm/min)
M201 X7000.00 Y7000.00 Z100.00 E300.00          ; set accelerations (mm/s^2)
...
G31 P500 X-28 Y-13 Z4.15                     ; set Z probe trigger value, offset and trigger height
...
M950 H1 C"out2" T1                           ; create nozzle heater output on out2 and map it to sensor 1
 M307 H1 R5.737 K0.569:0.336 D3.87 E1.35 S1.00 B0 ;Tool tuned for 255 degrees, V24.3 parameter omitted, tool not powered from Vin

;M307 H1 B0 R2.232 C222.5:137.6 D3.58 S1.00   ;Tool tuned for 195 degrees, V24.0 parameter omitted, tool not powered from Vin <--- OLD V6
...
M950 F0 C"!out4+out4.tach"                   ;Fan 3 uses out5, but we are using a PWM fan so the output needs to be inverted, and using out5.tach as a tacho input
...
M955 P0 I50 S1300 R16 C"spi.cs3+spi.cs2"
; Use Accelerometer 0, Zaccel faces -Ymachine and Xaccel faces
; Xmachine, Sample rate Hz, Resolution (bits), all wires
